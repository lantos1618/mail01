      ...
      <div className="mt-12 max-w-2xl mx-auto">
        ...
        <div className="space-y-6">
          <div className="bg-muted/50 rounded-lg p-6">
            <h3 className="font-semibold mb-2">Option 1: Gmail OAuth2</h3>
          ...
          <div className="bg-muted/50 rounded-lg p-6">
            <h3 className="font-semibold mb-2">Option 2: Development Mode</h3>
            <p className="text-sm">
        ...
        <div className="mt-8 p-4 border border-blue-200 bg-blue-50 dark:bg-blue-950 rounded-lg">
          <p className="text-sm">
            ...
            If Gmail fails, it saves locally. Your emails are never lost!
          </p>
        </div>
      </div>
    </div>
